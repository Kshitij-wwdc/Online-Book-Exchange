	...
	public void service(ServletRequest req, ServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("SELECT * FROM " + Users_Const.TABLE_USERS + " WHERE  "
					+ Users_Const.COLUMN_USERNAME + "=? AND " + Users_Const.COLUMN_PASSWORD + "=? AND "
					+ Users_Const.COLUMN_USERTYPE + "=1");
			...
			if (rs.next()) {
				...
				pw.println("<div class=\"tab\"><br/><a href=\"RemoveUser.html\">REMOVE USERS</a><br/></div>");
				pw.println("<div class=\"tab\"><br/><a href=\"viewbook\">VIEW BOOKS</a></div>");
			} else {

				RequestDispatcher rd = req.getRequestDispatcher("AdminLogin.html");
				rd.include(req, res);
				pw.println("<div class=\"tab\">Incorrect administrator credentials</div>");
			}
